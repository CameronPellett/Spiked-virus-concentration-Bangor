...
pairwise.meth.ttest <- pairwise.t.test(log(clean_ww_15$rec), clean_ww_15$method)

ex.pairwise_label <- pairwise_plot_layer(pairwise.meth.ttest,
...
clean_ww_15|>
  ...
  geom_boxplot(outlier.alpha = 0)+
  geom_beeswarm(alpha = 0.5)+
  geom_point(x = 2.9, y = 45, size = 95, shape = 15, colour = "white")+
  geom_point(x = 2.9, y = 45, size = 95, shape = 0)+
  geom_point(x = 1.25, y = 38, size = 90, shape = 15, colour = "white")+
  geom_point(x = 1.25, y = 38, size = 90, shape = 0)+
